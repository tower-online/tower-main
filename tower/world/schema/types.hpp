...
#ifndef FLATBUFFERS_GENERATED_TYPES_TOWER_WORLD_SCHEMA_H_
#define FLATBUFFERS_GENERATED_TYPES_TOWER_WORLD_SCHEMA_H_
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(1) TileData FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  TileData(tower::world::schema::TileType _type, tower::world::schema::TileState _state)
      : type_(::flatbuffers::EndianScalar(static_cast<uint8_t>(_type))),
        state_(::flatbuffers::EndianScalar(static_cast<uint8_t>(_state))) {
  }
  tower::world::schema::TileType type() const {
    return static_cast<tower::world::schema::TileType>(::flatbuffers::EndianScalar(type_));
  }
  tower::world::schema::TileState state() const {
    return static_cast<tower::world::schema::TileState>(::flatbuffers::EndianScalar(state_));
  }
};
...
#endif  // FLATBUFFERS_GENERATED_TYPES_TOWER_WORLD_SCHEMA_H_
