...
#ifndef FLATBUFFERS_GENERATED_TYPES_TOWER_WORLD_DATA_H_
#define FLATBUFFERS_GENERATED_TYPES_TOWER_WORLD_DATA_H_
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(1) TileData FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  TileData(tower::world::data::TileType _type, tower::world::data::TileState _state)
      : type_(::flatbuffers::EndianScalar(static_cast<uint8_t>(_type))),
        state_(::flatbuffers::EndianScalar(static_cast<uint8_t>(_state))) {
  }
  tower::world::data::TileType type() const {
    return static_cast<tower::world::data::TileType>(::flatbuffers::EndianScalar(type_));
  }
  tower::world::data::TileState state() const {
    return static_cast<tower::world::data::TileState>(::flatbuffers::EndianScalar(state_));
  }
};
...
#endif  // FLATBUFFERS_GENERATED_TYPES_TOWER_WORLD_DATA_H_
